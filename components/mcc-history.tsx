                ...
                <div className="space-y-6 sm:space-y-8">
                  <article>
                    ...
                    <div className="bg-gray-50 p-4 sm:p-6 rounded-lg mb-4">
                      ...
                      <ol className="list-decimal list-inside space-y-2 text-sm text-base sm:text-lg text-gray-700 ml-2">
                    ...
                    <div className="bg-blue-50 p-4 sm:p-6 rounded-lg mb-4">
                      ...
                      <div className="space-y-2 text-xs  text-gray-700 ext-base sm:text-lg">
                  ...
                  <article>
                    ...
                    <p className="ext-base sm:text-lg text-gray-700 leading-relaxed mb-4">
                  ...
                  <article>
                    ...
                    <div className="bg-amber-50 p-4 sm:p-6 rounded-lg mb-4 border-l-4 border-[#CE0000] italic">
                      <p className="font-semibold text-[#CE0000] ext-base sm:text-lg mb-2">"A New Body With Justifiable Ambition"</p>
                      <p className="text-xs ext-base sm:text-lg text-gray-700">
                    ...
                    <div className="bg-green-50 p-4 sm:p-6 rounded-lg mb-4">
                      <p className="font-semibold text-[#003087] text-base sm:text-lg mb-3">Committee of Management - First Year:</p>
            ...
            <div className="flex gap-4 sm:gap-6">
              ...
              <div className="flex-1 pb-4">
                ...
                <div className="space-y-6 sm:space-y-8">
                  ...
                  <div className="bg-blue-50 p-4 sm:p-6 rounded-lg mb-4">
                    <p className="font-semibold text-[#003087] text-base sm:text-lg">Purpose of the Malaysian Ceylonese Congress:</p>
                    <p className="text-base sm:text-lg text-gray-700 mt-2">To promote and safeguard the Political, Educational, Social and Cultural interests of the Malaysian Ceylonese Community.</p>
                  </div>

                  <p className="text-base sm:text-lg text-gray-700 leading-relaxed italic border-l-4 border-[#CE0000] pl-4">
              ...
              <div className="flex-1 pb-4">
                ...
                <div className="space-y-6 sm:space-y-8">
                  <article>
                    ...
                    <div className="bg-green-50 p-4 sm:p-6 rounded-lg mb-4">
                      <p className="font-semibold text-[#003087] text-base sm:text-lg mb-3">The Societies Act 1966 Registration:</p>
                      <div className="space-y-2 text-base sm:text-lg text-gray-700">
                  ...
                  <article>
                    ...
                    <div className="bg-blue-50 p-4 sm:p-6 rounded-lg mb-4">
                      <p className="font-semibold text-[#003087] text-base sm:text-lg mb-4">Executive Committee (1967):</p>
                      <div className="space-y-2 text-base sm:text-lg text-gray-700">
                  ...
                  <article>
                    ...
                    <div className="bg-purple-50 p-4 sm:p-6 rounded-lg mb-4">
                      <p className="font-semibold text-[#003087] text-base sm:text-lg mb-3">Inaugural Pro-tern Executive Committee (1969-1970):</p>
                      <div className="space-y-2 text-base sm:text-lg text-gray-700">
                ...
                <div className="space-y-6 sm:space-y-8">
                  <article>
                    ...
                    <div className="bg-amber-50 p-4 sm:p-6 rounded-lg mb-4">
                      <p className="font-semibold text-[#003087] text-base sm:text-lg mb-4">New Constitution Adopted:</p>
                      <p className="text-base sm:text-lg text-gray-700 mb-3">
                  ...
                  <article>
                    ...
                    <div className="bg-blue-50 p-4 sm:p-6 rounded-lg mb-4">
                      ...
                      <p className="text-base sm:text-lg text-gray-700 mb-3 italic">
                  ...
                  <article>
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <ul className="list-disc list-inside space-y-1 text-base sm:text-lg text-gray-700 ml-4">
          ...
          <div className="relative mb-12 sm:mb-16 pb-8 sm:pb-12">
            <div className="flex gap-4 sm:gap-6">
              ...
              <div className="flex-1 pb-4">
                ...
                <div className="space-y-6 sm:space-y-8">
                  <article>
                    <h3 className="text-base sm:text-lg font-bold text-[#CE0000] mb-3 sm:mb-4">National Economic Consultative Council (1989)</h3>
                  ...
                  <article>
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <p className="text-base sm:text-lg text-gray-700 mb-2 font-semibold">New Branches Inaugurated:</p>
                        <ul className="list-disc list-inside space-y-1 text-base sm:text-lg text-gray-700 ml-4 mb-3">
                      ...
                      <div className="bg-red-50 p-4 rounded-lg border-l-4 border-[#CE0000]">
                        ...
                        <p className="text-base sm:text-lg  font-semibold text-gray-900 mb-2">Standing up for the Ceylonese</p>
                        <p className="text-base sm:text-lg  text-gray-700 mb-3 italic">
